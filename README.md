...
You can import our official Postman collection to test live endpoints:

- Download the collection file: [`/docs/MyStore_API.postman_collection.json`](./docs/MyStore_API.postman_collection.json)
- Import it directly into Postman and set your `baseUrl` variable to `https://hoangan-online-store.onrender.com`.
...
//Transactional Email Settings (Nodemailer)
